  ...
  return (
    <div>
        <Container style={{marginTop:'10rem', justifyContent:'center', textAlign:'center', alignItems:'center'}}>
            <h1 className='mt-3 mb-3' style={{fontSize:'40px', fontWeight:'700'}}>ABOUT US</h1>
            <p className='card-text mt-5'>
            <span style={{fontSize:'25px', fontWeight:'700', color:'red'}}>Formed </span>in the year 1990, Soroup Trading has continued to expand its capabilities to become one among the leading Importer & Dsitributor for FMCG & Non-Food Products in the Kingdom of Saudi Arabia.
